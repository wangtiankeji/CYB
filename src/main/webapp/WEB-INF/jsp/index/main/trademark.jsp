    ...
    <div class="index-common-header common-index-bg">
        <div class="index-common-innner ">
            ...
            <div class="index-common-note">
                <p>注：开公司，没商标？怎么敢出来混！赶快申请个商标保护吧。</p>
            </div>
            <div class="index-common-price">
                <div>价格：<span>￥880/每类</span></div>
                <ul>
    ...
    <div class="index-connon-content common-index-bg">
        <div class="index-common-innner">
            ...
            <ul class="index-content-class2">
                <li><span>商标申请</span><p><b style="color:#f70707">￥880</b>/每类 免代理费</p></li>
                <li><span>商标变更</span><p><b style="color:#f70707">￥500</b>/每类 代理费<b style="color:#5cce49">￥498</b></p></li>
                <li><span>商标续展</span><p><b style="color:#f70707">￥2000</b>每类 代理费<b style="color:#5cce49">￥498</b></p></li>
                <li><span>商标转让</span><p><b style="color:#f70707">￥1000</b>/每类 代理费<b style="color:#5cce49">￥498</b></p></li>
            </ul>
        </div>
    </div>
