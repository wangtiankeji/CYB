    ...
    <div class="index-common-header common-index-bg">
        <div class="index-common-innner ">
            ...
            <div class="index-common-note">
                <p>注：创业路上有风险？创客邦专业律师支招，让你少走弯路，创业法律问题，来咨询律师吧。</p>
            </div>
            <div class="index-common-price">
                <div>价格：<span>￥36/30分钟内</span></div>
                <ul>
    ...
    <div class="index-connon-content common-index-bg">
        <div class="index-common-innner">
            ...
            <ul class="index-content-class">
                ...
                <li><span>服务费用</span><p style="line-height: 4rem;margin-top:0;color:#f70707">￥36/30分钟</p></li>
                <li><span>律师资质</span><p>创客邦创业顾问，通过电话主动与您联系</p></li>
            </ul>
        </div>
    </div>
