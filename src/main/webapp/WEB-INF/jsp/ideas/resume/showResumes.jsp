...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		searchPage("${ctx}/resume/getResumes",searchData);
		//trCss();
	});

	function search() {
		searchPage("${ctx}/resume/getResumes",$("#resumeForm").serialize());
	}
	...
	function addResume(){
		openDialog({url:"/resume/addInit",callback:"saveResume"});
	}
	function updateResume(id){
		openDialog({url:"/resume/updateInit/"+id,callback:"updateResume"});
	}
...
<body>
	<div class="top">
		...
		<div class="main" >
			...
			<form id="resumeForm" action="">
			<div id="Search">
				昵称：<input type="text" name="nickname" value=""/>
				个人定位：<input type="text" name="goal" value="" /> 
